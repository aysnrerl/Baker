...
namespace BakerWebUI.Controllers
{
    public class ChefController : Controller
    {
        ...
        public async Task<IActionResult> ChefList()
        {
            ...
            var response = await client.GetAsync("https://localhost:7098/api/Chef");
        ...
        public async Task<IActionResult> CreateChef(CreateChefDto model)
        {
            ...
            var response = await client.PostAsync("https://localhost:7098/api/Chef", content);
        ...
        public async Task<IActionResult> UpdateChef(int id)
        {
            ...
            var responseMessage = await client.GetAsync("https://localhost:7098/api/Chef/" + id);
        ...
        public async Task<IActionResult> UpdateChef(int id, UpdateChefDto model)
        {
            ...
            var jsonData = JsonConvert.SerializeObject(model);
            var content = new StringContent(jsonData, Encoding.UTF8, "application/json");
            var response = await client.PutAsync("https://localhost:7098/api/Chef", content);
            if (response.IsSuccessStatusCode) {
                return RedirectToAction("ChefList");
            }
            return View(model);
        ...
        {
            var client = _httpClientFactory.CreateClient();
            var response = await client.DeleteAsync("https://localhost:7098/api/Chef/" + id);
            return RedirectToAction("ChefList");
        }
